...
namespace Dreamteck.Forever
{
    ...
    public class LevelGenerator : MonoBehaviour
    {
        ...
        {
            Debug.Log("onSequenceEntered: " + sequence + ", " + this.currentLevelIndex + ", " + this.enteredSegmentIndex + ", " + this.segments.Count);
            ...
            Debug.Log("onSequenceEntered Ended: " + sequence + ", " + this.currentLevelIndex + ", " + this.enteredSegmentIndex + ", " + this.segments.Count);
        }

	...
	public string FullPath
	{
		get
		{
			...
			if(location == ES3.Location.Resources)
			{
                ...
                {
                    // TODO throw new System.ArgumentException("Extension of file in Resources must be .bytes, but path given was \"" + path + "\"");
                    // Debug.LogError("Extension of file in Resources must be .bytes, but path given was \"" + path + "\"");
                }

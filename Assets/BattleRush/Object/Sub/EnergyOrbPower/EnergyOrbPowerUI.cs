                ...
                if (this.data != null)
                {
                    ...
                    if (energyOrbPower != null)
                    {
                        // set position
                        {
                            ...
                            if (levelGenerator != null)
                            {
                                /*Vector3 position = MakeObjectUpdate.GetPositionInLevelGenerator(levelGenerator, energyOrbPower.P.v.z);
                ...
                if (wrapProperty.p is EnergyOrbPower)
                {
                    switch ((EnergyOrbPower.Property)wrapProperty.n)
                    {
                        case EnergyOrbPower.Property.state:
                            dirty = true;
                            break;
                        case EnergyOrbPower.Property.P:
                            dirty = true;
                            break;
                        case EnergyOrbPower.Property.R:
                            dirty = true;
                            break;
                        default:

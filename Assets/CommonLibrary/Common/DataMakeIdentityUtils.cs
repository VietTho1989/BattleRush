                    ...
                    for (int i = 0; i < fieldInfos.Length; i++)
                    {
                        ...
                        if (fieldInfo.FieldType.IsSubclassOf(typeof(WrapProperty)))
                        {
                            ...
                            if (dataType != null && !dataType.IsSubclassOf(typeof(Data)))
                            {
                                ...
                                // Value Property
                                if (Data.IsSubclassOfRawGeneric(typeof(VO<>), fieldInfo.FieldType))
                                {
                                    // hook
                                ...
                                else if (Data.IsSubclassOfRawGeneric(typeof(LO<>), fieldInfo.FieldType))
                                {// listProperty
                    ...
                    bool needAddSyncListCallBack = false;
                    {
                        ...
                        for (int i = 0; i < fieldInfos.Length; i++)
                        {
                            ...
                            if (fieldInfo.FieldType.IsSubclassOf(typeof(WrapProperty)))
                            {
                                ...
                                if (dataType != null && !dataType.IsSubclassOf(typeof(Data)))
                                {
                                    if (Data.IsSubclassOfRawGeneric(typeof(LO<>), fieldInfo.FieldType))
                                    {

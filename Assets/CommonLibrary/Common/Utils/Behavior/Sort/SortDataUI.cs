...
public class SortDataUI : UIBehavior<SortDataUI.UIData>
{
    ...
    {
        public VD<EditData<SortData>> editSortData;

        #region filter

        public VD<RequestChangeStringUI.UIData> filter;
        ...
        public VD<RequestChangeEnumUI.UIData> sortType;
        ...
        public UIData() : base()
        {
            this.editSortData = new VD<EditData<SortData>>(this, (byte)Property.editSortData, new EditData<SortData>());
            // filter
            {
                this.filter = new VD<RequestChangeStringUI.UIData>(this, (byte)Property.filter, new RequestChangeStringUI.UIData());
                // event
                this.filter.v.updateData.v.request.v = makeRequestChangeFilter;
            }
            // sortType
            {
                this.sortType = new VD<RequestChangeEnumUI.UIData>(this, (byte)Property.sortType, new RequestChangeEnumUI.UIData());
                // event
        ...
        if (dirty)
        {
            ...
            if (this.data != null)
            {
                ...
                if (editSortData != null)
                {
                    ...
                    {
                        // get server state
                        DataUtils.ServerState serverState = RequestChange.GetServerState(editSortData);
                        // set origin
                        {

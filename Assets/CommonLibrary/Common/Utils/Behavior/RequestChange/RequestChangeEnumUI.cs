...
public class RequestChangeEnumUI : UIBehavior<RequestChangeEnumUI.UIData>
{
    ...
    public class UIData : RequestChange.UIData<int>
    {
        ...
        public UIData() : base()
        {
            ...
            this.options = new LO<string>(this, (byte)Property.options);
            // compare
            {
    ...
    public static void RefreshOptions(RequestChangeEnumUI.UIData requestChangeEnumUIData, List<string> options)
    {
        ...
        {
            Logger.LogError("requestChangeEnumUIData null");
        }
    }
    ...
    public override void Awake()
    {
        ...
        {
            Logger.LogError("drValue null: " + this);
        }
    }
    ...
    public override void refresh()
    {
        if (dirty)
        {
            ...
            if (this.data != null)
            {
                ...
                {
                    Logger.LogError("drValues null: " + this);
                }
                // Interactable

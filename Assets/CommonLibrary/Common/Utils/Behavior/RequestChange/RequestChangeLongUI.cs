...
public class RequestChangeLongUI : UIBehavior<RequestChangeLongUI.UIData>
{
    ...
    public class UIData : RequestChange.UIData<long>
    {
        ...
        public VD<RequestChangeLongUpdate.UpdateData> updateData;
        ...
        public UIData() : base()
        {
            this.updateData = new VD<RequestChangeLongUpdate.UpdateData>(this, (byte)Property.updateData, new RequestChangeLongUpdate.UpdateData());
            ...
            // compare
            {
                ...
                this.compare = new VO<long>(this, (byte)Property.compare, 0);
            }
        }

...
public class RequestChangeStringUI : UIBehavior<RequestChangeStringUI.UIData>
{
    ...
    public class UIData : RequestChange.UIData<string>
    {
        ...
        public VD<RequestChangeStringUpdate.UpdateData> updateData;

        #region compare

        public VO<bool> showDifferent;

        public VO<string> compare;

        #endregion

        public VO<string> placeHolder;

        public VO<InputField.ContentType> contentType;
        ...
        public UIData() : base()
        {
            this.updateData = new VD<RequestChangeStringUpdate.UpdateData>(this, (byte)Property.updateData, new RequestChangeStringUpdate.UpdateData());
            this.showDifferent = new VO<bool>(this, (byte)Property.showDifferent, false);
            this.compare = new VO<string>(this, (byte)Property.compare, "");
            this.placeHolder = new VO<string>(this, (byte)Property.placeHolder, "");
            this.contentType = new VO<InputField.ContentType>(this, (byte)Property.contentType, InputField.ContentType.Standard);
        }

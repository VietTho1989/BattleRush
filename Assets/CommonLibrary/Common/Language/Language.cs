...
namespace CommonLibrary
{
    public class Language : Data
    {
        ...
        public abstract class Force : Data
        {
            ...
            public class Have : Force
            {

                public VO<Language.Type> language;
                ...
                public Have() : base()
                {
                    this.language = new VO<Language.Type>(this, (byte)Property.language, Language.Type.en);
                }

...
namespace Record
{
    public class DataRecord
    {
        ...
        public float getCurrentTime()
        {
            float currentTime = 0;
            {
                if (pos >= 0 && pos < this.changes.Count)
                {
                    ...
                    {
                        Logger.LogError("change null: " + this);
                    }
                }
                else
                {
        ...
        public void makeBinary(BinaryWriter writer)
        {
            ...
            {
                Logger.LogError("why data null: " + this);
            }
        }
            ...
            if (data != null)
            {
                ...
                for (int i = startIndex; i < this.changes.Count; i++)
                {
                    // check processCount
                    {
                        ...
                        {
                            Logger.LogError("maxProcessCount: " + processCount + "; " + maxProcessCount);
                            break;
                        }
                    }
                    // check i
                            ...
                            if (change.t <= newTime)
                            {
                                ...
                                if (wrapChange != null)
                                {
                                    ...
                                    if (wrapProperty != null)
                                    {
                                        ...
                                        {
                                            Logger.LogError("processRedo error: " + e);
                                        }
                                    }
                                    else
                                    {
                                        Logger.LogError("wrapProperty null: " + this);
                                    }
                                }
                                else
                                {
                                    Logger.LogError("wrapChange null: " + this);
                                }
                                this.pos = i;
                                processCount++;
                            }
                            ...
                            if (change.t >= newTime)
                            {
                                ...
                                if (wrapChange != null)
                                {
                                    ...
                                    if (wrapProperty != null)
                                    {
                                        ...
                                        {
                                            Logger.LogError("processUndo error: " + e);
                                        }
                                    }
                                    else
                                    {

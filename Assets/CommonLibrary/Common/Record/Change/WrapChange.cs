...
public class WrapChange : HistoryChange
{
                    ...
                    for (int i = 0; i < count; i++)
                    {
                        ...
                        switch ((Sync<T>.Type)type)
                        {
                            ...
                            case Sync<T>.Type.Remove:
                                ...
                                break;
                            default:
                                Logger.LogError("unknown type: " + type + "; " + this);
                                break;
                        }
                    }
                }
    ...
    {
        this.pi = new VO<List<SI>>(this, (byte)Property.pi, new List<Data.SI>());
        this.vn = new VO<byte>(this, (byte)Property.vn, 0);
        this.syncs = new VO<byte[]>(this, (byte)Property.syncs, new byte[0]);
    }

...
#pragma warning disable CS0618
    ...
    public void getParentList(List<Data> parentList)
    {
        if (this.p != null)
        {
            ...
            {
                Logger.LogError("parent wrapProperty parent null: " + this);
            }
        }
        else
        {
            Logger.LogError("parent wrapProperty null: " + this);
            return;
        }
    }
    ...
    {
        foreach (ValueChangeCallBack callBack in callBacks)
        {
    ...
    public static Transform FindTransform(Data data)
    {
        Transform ret = null;
        {
            if (data != null)
            {
                ...
                {
                    Logger.LogError("uiGameObject null");
                }
            }
            else
            {
        ...
        if (ret == null)
        {
            Logger.LogError("find transform null: " + data);
        }
        return ret;
    }
    ...
    public static void RefreshStrEditType(RequestChangeEnumUI.UIData requestEditType)
    {
        ...
        {
            Logger.LogError("requestEditType null");
        }
    }
    ...
    public static void RefreshStrEditType(Dropdown drEditType)
    {
        ...
        {
            Logger.LogError("drEditType null");
        }
    }

    static Data()
    {
        txtImmediately.add(CommonLibrary.Language.Type.vi, "Ngay lập tức");
        txtLater.add(CommonLibrary.Language.Type.vi, "Sau này");
    }
    ...
    public static byte[] MakeBinary(Data data)
    {
        byte[] byteArray = null;
        {
            ...
            {
                Logger.LogError("data null: " + data);
            }
        }
        return byteArray;
    }
        ...
        Data outData = null;
        {
            try
            {
                // class name
                {
                    ...
                    {
                        Logger.LogError("className null: " + reader);
                    }
                }
                if (outData != null)
                {
                ...
                {
                    Logger.LogError("outData null: " + outData);
                }
            }
            catch (Exception e)
            {
                Logger.LogError("data utils parse: " + e);
            }
        }
        return outData;
    }
    ...
    public WrapProperty findProperty(WrapChange change)
    {
        ...
        {
            Logger.LogError("Cannot find data");
            return null;
        }
    }
